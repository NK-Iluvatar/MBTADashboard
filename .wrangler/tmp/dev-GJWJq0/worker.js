  ...
  async fetch(request, env2, ctx) {
    ...
    if (url.pathname.startsWith("/api/")) {
      if (url.pathname.startsWith("/api/mbta")) {
        ...
        const apiUrl = `https://api-v3.mbta.com${mbtaPath}${url.search}&api_key=${env2.MBTA_API_KEY}`;
...
// .wrangler/tmp/bundle-163UMz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-163UMz/middleware-loader.entry.ts
